...
describe('api/Metadata', () => {
    ...
    describe('getTemplates()', () => {
        test('should return unhidden templates that are not classification', () =>
    ...
    describe('getClassification()', () => {
        ...
        test('should not make request but get classification from cache and call success handler', () =>
            __awaiter(this, void 0, void 0, function*() {
                const success = jest.fn();
                const error = jest.fn();
                const file = {
        ...
        test('should get classification from cache and call success handler, and then refresh the cache by making a request', () =>
            __awaiter(this, void 0, void 0, function*() {
                const success = jest.fn();
                const error = jest.fn();
                const file = {
