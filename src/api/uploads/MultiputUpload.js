...
class MultiputUpload extends BaseMultiput {
    ...
    constructor(options, config) {
         ...
         * @return {string}
         */
        this.getBaseUploadUrlFromPreflightResponse = ({ data }) => {
         ...
         * @return {void}
         */
        this.preflightSuccessHandler = (preflightResponse) => __awaiter(this, void 0, void 0, function* () {
            if (this.isDestroyed()) {
                return;
            }
            ...
            try {
                const response = yield this.xhr.post({
         ...
         * @return {void}
         */
        this.partUploadSuccessHandler = (part) => {
         ...
         * @return {void}
         */
        this.partUploadErrorHandler = (error, eventInfo) => {
         ...
         * @return {void}
         */
        this.updateProgress = (prevUploadedBytes, newUploadedBytes) => {
            if (this.isDestroyed()) {
                return;
            }
        ...
        this.commitSession = () => {
            ...
            const fileSha1 = (this.fileSha1), any;
            const headers = {
                Digest: `sha=${fileSha1}`,
         ...
         * @return {void}
         */
        this.commitSessionSuccessHandler = (response) => {
            if (this.isDestroyed()) {
                return;
            }
         ...
         * @return {void}
         */
        this.commitSessionErrorHandler = (error) => {
            if (this.isDestroyed()) {
                return;
            }
         ...
         * @return {number}
         */
        this.getNumPartsUploading = () => this.numPartsUploading;
        this.parts = [];
     ...
     * @return {void}
     */
    upload({ file, folderId, errorCallback, progressCallback, successCallback, overwrite = true, fileId, }) {
        this.file = file;
    ...
    createSessionSuccessHandler(data) {
        ...
        this.sessionEndpoints = Object.assign({}, this.sessionEndpoints, { uploadPart: session_endpoints.upload_part, listParts: session_endpoints.list_parts, commit: session_endpoints.commit, abort: session_endpoints.abort, logEvent: session_endpoints.log_event });
        this.populateParts();
        this.processNextParts();
    }
    /**
     ...
     * @return {Promise}
     */
    sessionErrorHandler(error, logEventType, logMessage) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield retryNumOfTimes((resolve, reject) => {
     ...
     * @return {Promise}
     */
    computeDigestForPart(part) {
        return __awaiter(this, void 0, void 0, function* () {
            const blob = this.file.slice(part.offset, part.offset + this.partSize);
            const reader = new window.FileReader();
            const startTimestamp = Date.now();
            try {
                const { buffer, readCompleteTimestamp, } = yield this.readFile(reader, blob);
                const sha256ArrayBuffer = yield digest('SHA-256', buffer);
