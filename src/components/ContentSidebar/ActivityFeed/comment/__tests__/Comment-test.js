...
describe('components/ContentSidebar/ActivityFeed/comment/Comment', () => {
    beforeEach(() => {
        ApprovalCommentForm.default = jest.fn().mockReturnValue(/>);, InlineEdit.default = jest.fn().mockReturnValue(/>);));
    });
    const render = (props = {}) => shallow(created_by, {}, { name: '50 Cent', id: 10 });
}, id = "123", tagged_message = "test", handlers = { allHandlers }, currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, Object.assign({}, props) /  > );
test('should correctly render comment', () => {
    ...
    const wrapper = shallow(id, "123", Object.assign({}, comment), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, handlers = { allHandlers }
        /  > );
...
test('should correctly render comment when translation is enabled', () => {
    ...
    const wrapper = shallow(id, "123", Object.assign({}, comment), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, handlers = { allHandlers }, translations = { translations }
        /  > );
    expect(wrapper).toMatchSnapshot();
});
...
test('should not allow actions when comment is pending', () => {
    ...
    const wrapper = shallow(id, "123", Object.assign({}, comment), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, handlers = { allHandlers }, onDelete = { jest, : .fn() }
        /  > );
...
test('should allow user to delete if they have delete permissions on the task and delete handler is defined', () => {
    ...
    const wrapper = shallow(id, "123", Object.assign({}, task), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, handlers = { allHandlers }, onDelete = { jest, : .fn() }
        /  > );
    expect(wrapper.find('InlineDelete').length).toEqual(1);
});
test('should allow user to edit if they have edit permissions on the task and edit handler is defined', () => {
    ...
    const wrapper = mount(id, "123", Object.assign({}, comment), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, handlers = { allHandlers }, onEdit = { jest, : .fn() }
        /  > );
...
test('should not allow user to edit if they lack edit permissions on the comment', () => {
    ...
    const wrapper = shallow(id, "123", Object.assign({}, comment), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, handlers = { allHandlers }, onEdit = { jest, : .fn() }
        /  > );
    expect(wrapper.find('InlineEdit').length).toEqual(0);
});
test('should not allow comment creator to delete if onDelete handler is undefined', () => {
    ...
    const wrapper = shallow(id, "123", Object.assign({}, comment), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }
        /  > );
    expect(wrapper.find('InlineDelete').length).toEqual(0);
});
...
test('should render an error when one is defined', () => {
    ...
    const wrapper = shallow(id, "123", Object.assign({}, comment), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, handlers = { allHandlers }, onDelete = { jest, : .fn() }, error = {}, {
        title: 'error',
        message: 'errorrrrr',
    });
}, />,);
...
test('should render an error cta when an action is defined', () => {
    ...
    const wrapper = mount(id, "123", Object.assign({}, comment), currentUser = { currentUser }, approverSelectorContacts = { approverSelectorContacts }, mentionSelectorContacts = { mentionSelectorContacts }, handlers = { allHandlers }, onDelete = { jest, : .fn() }, error = {}, {
        title: 'error',
        message: 'errorrrrr',
        action: {
            text: 'click',
